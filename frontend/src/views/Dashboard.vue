      ...
      <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
          ...
          <div v-else-if="recentProposals.length === 0" class="text-center py-8">
            ...
            <p class="mt-1 text-sm text-gray-500">Начните с создания нового обращения.</p>
          </div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm font-medium text-gray-900">Создать обращение</p>
                <p class="text-sm text-gray-500">Добавить новое обращение в систему</p>
              </div>
            </RouterLink>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <span class="absolute inset-0" aria-hidden="true" />
                <p class="text-sm font-medium text-gray-900">Поиск</p>
                <p class="text-sm text-gray-500">Найти обращения по содержимому</p>
              </div>
            </RouterLink>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-gray-500">Статистика и отчеты</p>
              </div>
            </RouterLink>
          </div>
        </div>
